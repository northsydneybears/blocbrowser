...
- (void)showAlert {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Stand Aside, Stand Aside", @"Welcome title")
                                                    message:NSLocalizedString(@"Here come the Mighty Bears!", @"Welcome comment")
                                                   delegate:nil
                                          cancelButtonTitle:NSLocalizedString(@"North Sydney", @"Welcome button title") otherButtonTitles:nil];
    [alert show];
}
